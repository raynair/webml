 ...
 * @generated
 */
public class WebmlSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WebmlPackage.MENU: {
				Menu menu = (Menu)theEObject;
				T result = caseMenu(menu);
				if (result == null) result = casePage(menu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebmlPackage.SUBMENU: {
				Submenu submenu = (Submenu)theEObject;
				T result = caseSubmenu(submenu);
				if (result == null) result = casePage(submenu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebmlPackage.SUBSUBMENU: {
				Subsubmenu subsubmenu = (Subsubmenu)theEObject;
				T result = caseSubsubmenu(subsubmenu);
				if (result == null) result = casePage(subsubmenu);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case WebmlPackage.WEB: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Submenu</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Submenu</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Subsubmenu</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Subsubmenu</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSubsubmenu(Subsubmenu object) {
		return null;
	}
