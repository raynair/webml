...
public class WebmlAdapterFactory extends AdapterFactoryImpl {
	...
	protected WebmlSwitch<Adapter> modelSwitch =
		new WebmlSwitch<Adapter>() {
			...
			@Override
			public Adapter caseSubsubmenu(Subsubmenu object) {
				return createSubsubmenuAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.malime.ecore.webml.Menu <em>Menu</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.malime.ecore.webml.Meta <em>Meta</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.malime.ecore.webml.Page <em>Page</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.malime.ecore.webml.Submenu <em>Submenu</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.malime.ecore.webml.Subsubmenu <em>Subsubmenu</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSubsubmenuAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link de.malime.ecore.webml.Web <em>Web</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
